...
export default function AdminDashboard_v11() {
  // 🧾 Activity Log State
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-gradient-to-br from-soft via-white to-soft p-10">
        ...
        >
          © {new Date().getFullYear()} AHE Tech • Secure Patrol Management System v1.1
        </motion.div>
      </div>
    </ErrorBoundary>
  );
